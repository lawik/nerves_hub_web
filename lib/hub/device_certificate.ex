defmodule Hub.DeviceCertificate do
  use Ash.Resource,
    domain: Hub,
  ...
  postgres do
    ...
    identity_index_names device_id_serial: "device_certificates_device_id_serial_index",
                         fingerprint: "device_certificates_fingerprint_index"
  end
  ...
  attributes do
    ...
    attribute :public_key_fingerprint, :string do
      sensitive? true
      public? true
    end
  end
  ...
  identities do
    identity :device_id_serial, [:device_id, :serial]
